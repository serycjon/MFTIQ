...
from MFTIQ.RAFT.core.update import BasicUpdateBlock, SmallUpdateBlock, OcclusionAndUncertaintyBlock
from MFTIQ.RAFT.core.extractor import BasicEncoder, SmallEncoder
from MFTIQ.RAFT.core.corr import CorrBlock, AlternateCorrBlock
from MFTIQ.RAFT.core.utils.utils import coords_grid, upflow8, upsample8
...
class RAFT_ORIG(nn.Module):
    def __init__(self, args):
        super(RAFT_ORIG, self).__init__()
        self.args = args
