...
import MFTIQ.RoMa.roma
from MFTIQ.RoMa.roma.utils import get_tuple_transform_ops
from MFTIQ.RoMa.roma.utils.local_correlation import local_correlation
from MFTIQ.RoMa.roma.utils.utils import cls_to_flow_refine
from MFTIQ.RoMa.roma.utils.kde import kde
...
class RegressionMatcher(nn.Module):
    ...
    def visualize_warp(self, warp, certainty, im_A = None, im_B = None, im_A_path = None, im_B_path = None, device = "cuda", symmetric = True, save_path = None):
        ...
        if save_path is not None:
            from MFTIQ.RoMa.roma.utils import tensor_to_pil
