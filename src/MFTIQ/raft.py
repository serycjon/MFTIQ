...
from MFTIQ.utils.geom_utils import torch_get_featuremap_coords, get_featuremap_coords
from MFTIQ.utils.misc import ensure_numpy

from MFTIQ.RAFT.core.raft import RAFT  # noqa: E402
from MFTIQ.RAFT.core.utils.utils import InputPadder  # noqa: E402
...
class RAFTWrapper():
    ...
    def compute_flow_direct(self, src_img, dst_img, **kwargs):
        iters = kwargs.get('iters', self.C.flow_iters)
        all_predictions = self.model(src_img, dst_img, iters=iters, test_mode=True)
