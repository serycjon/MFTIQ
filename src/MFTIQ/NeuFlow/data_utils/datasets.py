...
from MFTIQ.NeuFlow.data_utils.transforms import FlowAugmentor, SparseFlowAugmentor
...
def build_train_dataset(stage):
    if stage == 'chairs':
        ...
        clean_dataset = FlyingThings3D(aug_params, dstype='frames_cleanpass', load_occlusion=True)
        final_dataset = FlyingThings3D(aug_params, dstype='frames_finalpass', load_occlusion=True)
        ...
        things_final = FlyingThings3D(aug_params, dstype='frames_finalpass', load_occlusion=True)
