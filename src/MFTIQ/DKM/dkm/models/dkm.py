...
from MFTIQ.DKM.dkm.utils import get_tuple_transform_ops
from einops import rearrange
from MFTIQ.DKM.dkm.utils.local_correlation import local_correlation
...
class RegressionMatcher(nn.Module):
    ...
    def sample(
        ...
        from MFTIQ.DKM.dkm.utils.kde import kde
